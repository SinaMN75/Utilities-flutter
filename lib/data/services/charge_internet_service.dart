...
class ChargeInternetService {
  Future<UHttpClientResponse> pin({
  ...
  Future<UHttpClientResponse> topup({
  ...
  Future<UHttpClientResponse> internetReserve({
  ...
  Future<UHttpClientResponse> getStatus({
    ...
    body: p.toMap().add("apiKey", U.apiKey).add("token", ULocalStorage.getToken()),
    onSuccess: (final Response r) => onOk?.call(UResponse<GetStatusResponse>.fromJson(r.body, (final dynamic i) => GetStatusResponse.fromMap(i))),
    onError: (final Response r) => onError?.call(UEmptyResponse.fromJson(r.body)),
    onException: (String e) => onException?.call(e),
  );

  Future<UHttpClientResponse> getBalance({
    ...
    body: p.toMap().add("apiKey", U.apiKey).add("token", ULocalStorage.getToken()),
    onSuccess: (final Response r) => onOk?.call(UResponse<GetBalanceResponse>.fromJson(r.body, (final dynamic i) => GetBalanceResponse.fromMap(i))),
    onError: (final Response r) => onError?.call(UEmptyResponse.fromJson(r.body)),
    onException: (String e) => onException?.call(e),
  );

  Future<UHttpClientResponse> echo({
    required final UBaseParams p,
    ...
    body: p.toMap().add("apiKey", U.apiKey).add("token", ULocalStorage.getToken()),
    onSuccess: (final Response r) => onOk?.call(UResponse<EchoResponse>.fromJson(r.body, (final dynamic i) => EchoResponse.fromMap(i))),
    onError: (final Response r) => onError?.call(UEmptyResponse.fromJson(r.body)),
    onException: (String e) => onException?.call(e),
  );

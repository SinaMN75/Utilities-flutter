...
class UserJsonDetail {
  ...
  factory UserJsonDetail.fromMap(final Map<String, dynamic> json) => UserJsonDetail(
        ...
        height: json["height"],
        health1: json["health1"] == null ? null : List<String>.from(json["health1"]?.map((final dynamic x) => x)),
        health2: json["health2"] == null ? null : List<String>.from(json["health2"]?.map((final dynamic x) => x)),

...
class ProductCreateUpdateDto {
  ...
  dynamic toMap() => {
    ...
    "relatedProducts": relatedProducts == null ? [] : List<dynamic>.from(relatedProducts!.where((final String element) => element != '').map((final String x) => x)),
...
class ProductFilterDto {
  ...
  factory ProductFilterDto.fromMap(final Map<String, dynamic> json) => ProductFilterDto(
    ...
    ids: json["ids"] == null ? null : List<String>.from(json["ids"]!.map((final x) => x)),
  ...
  Map<String, dynamic> toMap() => {
    ...
    "ids": ids == null ? [] : List<dynamic>.from(ids!.map((final String x) => x)),
    "tags": tags == null ? [] : List<dynamic>.from(tags!.map((final int x) => x)),

...
class UserDataSource {
  ...
  Future<void> delete({
    ...
    final Function(String error)? failure,
      ...
      httpDelete(
        url: "$baseUrl/user/$id",
        action: (Response response) => onResponse(GenericResponse<String>.fromJson(response.data, fromMap: UserReadDto.fromMap)).toList(),
        error: (Response response) => onError(GenericResponse.fromJson(response.data)),
        failure: failure,
      );
  ...
  Future<void> getGrowthRate({
    ...
    final Function(String error)? failure,
      ...
      httpGet(
        ...
        action: (Response response) => onResponse(GenericResponse<GrowthRateReadDto>.fromJson(response.data, fromMap: GrowthRateReadDto.fromMap)).toList(),
        error: (Response response) => onError(GenericResponse.fromJson(response.data)),
        failure: failure,
      );

    ...
    final Function(String error)? failure,
      ...
      httpPost(
        ...
        action: (Response response) => onResponse(
            GenericResponse<String>.fromJson(response.body,
                fromMap: CreateMailSmsNotificationDto.fromMap)),
  ...
  Future<void> sendOtpSms({
    ...
    final Function(String error)? failure,
      ...
      httpPost(
        ...
        body: dto,
        action: (Response response) => onResponse == null
            ? () {}
            : onResponse(GenericResponse<String>.fromJson(response.body)),
        error: (Response response) => onError == null
            ? () {}
            : onError(GenericResponse.fromJson(response.body)),
        failure: failure,
      );

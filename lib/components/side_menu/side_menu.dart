...
part "global.dart";
part "side_menu_item_with_global.dart";
part "side_menu_style.dart";
...
class _SideMenuState extends State<SideMenu> {
  ...
  @override
  void dispose() {
    Future<void>.delayed(Duration.zero, () => widget.global.displayModeState.change(widget.global.displayModeState.value));
    super.dispose();
  }
}

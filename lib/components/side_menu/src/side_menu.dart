...
import "package:u/components/side_menu/src/side_menu_expansion_item.dart";
import "package:u/components/side_menu/src/side_menu_expansion_item_with_global.dart";
import "package:u/components/side_menu/src/side_menu_hamburger_mode.dart";
...
import "package:u/components/side_menu/src/side_menu_style.dart";
import "package:u/components/side_menu/src/side_menu_toggle.dart";
...
class SideMenu extends StatefulWidget {
  ...
  SideMenu({
    ...
    sidemenuitems.items = items.map((dynamic data) {
...
class _SideMenuState extends State<SideMenu> {
  ...
  double _calculateOpenWidth() {
    ...
    Future<void>.delayed(_toggleDuration(), () {
      ...
      for (Function update in widget.global.itemsUpdate) {
        update();
      }
    });
        ...
        : AnimatedContainer(
            ...
            child: Stack(
              children: <Widget>[
                ...
                if ((widget.footer != null && widget.global.displayModeState.value != SideMenuDisplayMode.compact) || (widget.footer != null && alwaysShowFooter))
                  Align(

...
import 'package:utilities/utils/multi_formatter/formatters/all_fiat_currencies.dart';
...
String _getThousandSeparator(
  ...
  if (thousandSeparator == ThousandSeparator.SpaceAndCommaMantissa || thousandSeparator == ThousandSeparator.SpaceAndPeriodMantissa || thousandSeparator == ThousandSeparator.Space) {
    return ' ';
  }

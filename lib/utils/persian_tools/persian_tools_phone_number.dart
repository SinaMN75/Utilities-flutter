class PersianToolsPhoneNumberConstants {
  ...
  static const defaultIrancellModel = OperatorDetail(
    provinces: [],
    base: 'کشوری',
    type: SimCardType.both,
  ...
  static const shatelName = 'شاتل موبایل';

  static const MCIName = 'همراه اول';

  static const irancellName = 'ایرانسل';

  static const taliaName = 'تالیا';

  static const rightTelName = 'رایتل';

  static const samanTelName = 'سامانتل';
}
...
class PersianToolsPhoneNumber {
  ...
  bool phoneNumberValidator(String phoneNumber) {
    return PersianToolsPhoneNumberConstants.mobileRegex.hasMatch(phoneNumber) && PersianToolsPhoneNumberConstants.prefixes.contains(getPhonePrefix(phoneNumber));
  }
}
...
class Operator {
  ...
  static const shatelMobile = Operator._(PersianToolsPhoneNumberConstants.shatelName);
  static const MCI = Operator._(PersianToolsPhoneNumberConstants.MCIName);
  static const irancell = Operator._(PersianToolsPhoneNumberConstants.irancellName);
  static const taliya = Operator._(PersianToolsPhoneNumberConstants.taliaName);
  static const rightTel = Operator._(PersianToolsPhoneNumberConstants.rightTelName);
  static const samanTel = Operator._(PersianToolsPhoneNumberConstants.samanTelName);

import 'package:utilities/utils/persian_tools/src/constants/bill/constants.dart';
...
class Bill {
  ...
  bool get isPaymentIdValid {
    ...
    return _calTheBit(paymentIdStr) == int.parse(firstControlBit) && _calTheBit(billIdSrt + paymentIdStr + firstControlBit) == int.parse(secondControlBit);
  }

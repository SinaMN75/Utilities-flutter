...
import 'package:utilities/utils/persian_tools/src/constants/words_to_number/constants.dart';
import 'package:utilities/utils/persian_tools/src/internal_methods.dart';
...
String? wordsToNumberString(
  ...
  final addedCommasIfNeeded = addComma ? computeNumbers.addComma : computeNumbers.toString();

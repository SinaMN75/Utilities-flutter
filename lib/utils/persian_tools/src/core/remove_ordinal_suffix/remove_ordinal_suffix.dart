import 'package:utilities/utils/persian_tools/src/constants/remove_ordinal_suffix/constants.dart';

/// Removes ordinal suffixes to numbers
String removeOrdinalSuffix(String word) {
  if (word.isEmpty) return word;

  word = word.replaceAll(RegExp(ordinalSuffix, caseSensitive: false), '').replaceAll(RegExp(ordinalSuffixSeparate, caseSensitive: false), '');

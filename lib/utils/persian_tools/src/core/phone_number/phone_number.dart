import 'package:utilities/utils/persian_tools/src/constants/phone_number/constants.dart';
...
bool phoneNumberValidator(String phoneNumber) {
  return mobileRegex.hasMatch(phoneNumber) && prefixes.contains(getPhonePrefix(phoneNumber));
}

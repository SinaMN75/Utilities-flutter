import 'package:utilities/utils/persian_tools/src/core/sheba/model.dart';
...
var _banksInfo = <BankInformation>[
  ...
  BankInformation(nickname: 'parsian', name: 'Parsian Bank', persianName: 'بانک پارسیان', code: '054', isAccountNumberAvailable: true, process: _parsianBankProc),
  ...
  BankInformation(nickname: 'pasargad', name: 'Pasargad Bank', persianName: 'بانک پاسارگاد', code: '057', isAccountNumberAvailable: true, process: _pasargadBankProc),
  ...
  BankInformation(nickname: 'shahr', name: 'City Bank', persianName: 'بانک شهر', code: '061', isAccountNumberAvailable: true, process: _shahrBankProc),
...
AccountNumberModel _parsianBankProc(String string) {
  ...
  var formatted = '0' + string.substring(0, 3) + '-0' + string.substring(2, 8) + '-' + string.substring(9, 12);
...
AccountNumberModel _pasargadBankProc(String string) {
  ...
  var formatted = string.substring(0, 4) + '-' + string.substring(3, 6) + '-' + string.substring(6, 14) + '-' + string[14];
  return AccountNumberModel(
    accountNumber: string,
    formattedAccountNumber: formatted,
  );

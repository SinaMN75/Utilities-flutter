...
Future<Jalali?> showPersianDatePicker({
  ...
  assert(selectableDayPredicate == null || selectableDayPredicate(initialDate), 'Provided initialDate $initialDate must satisfy provided selectableDayPredicate.');
...
class _DatePickerDialog extends StatefulWidget {
  _DatePickerDialog({
    ...
    assert(selectableDayPredicate == null || selectableDayPredicate!(this.initialDate), 'Provided initialDate ${this.initialDate} must satisfy provided selectableDayPredicate');
  }
...
class _DatePickerDialogState extends State<_DatePickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle? dateStyle = orientation == Orientation.landscape ? textTheme.titleMedium?.copyWith(color: dateColor) : textTheme.headlineSmall?.copyWith(color: dateColor);

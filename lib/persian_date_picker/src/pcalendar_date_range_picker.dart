...
class PCalendarDateRangePicker extends StatefulWidget {
  ...
  PCalendarDateRangePicker({
    ...
    required this.onEndDateChanged,
        ...
        super(key: key) {
    assert(this.initialStartDate == null || this.initialEndDate == null || !this.initialStartDate!.isAfter(initialEndDate!), 'initialStartDate must be on or before initialEndDate.');

...
import 'package:utilities/persian_date_picker/persian_datetime_picker.dart';
import 'package:utilities/persian_date_picker/src/cupertino/strings.dart';
import 'package:utilities/persian_date_picker/src/date/shamsi_date.dart';
  ...
  static double _getColumnWidth(
    ...
    switch (columnType) {
      ...
      case _PickerColumnType.dayPeriod:
        longestText = StringsText.anteMeridiemAbbreviation.length > StringsText.postMeridiemAbbreviation.length ? StringsText.anteMeridiemAbbreviation : StringsText.postMeridiemAbbreviation;
        break;
    ...
    return PCupertinoPicker(
      ...
      children: List<Widget>.generate(24, (int index) {
        final String semanticsLabel =
            textDirectionFactor == 1 ? StringsText.timerPickerHour(index) + StringsText.timerPickerHourLabel(index) : StringsText.timerPickerHourLabel(index) + StringsText.timerPickerHour(index);
...
class _CupertinoDatePickerDateTimeState extends State<_CupertinoDatePickerDateTime> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!widget.use24hFormat) {
      if (StringsText.datePickerDateTimeOrder == DatePickerDateTimeOrder.date_time_dayPeriod || StringsText.datePickerDateTimeOrder == DatePickerDateTimeOrder.time_dayPeriod_date) {
...
class _CupertinoDatePickerDateState extends State<_CupertinoDatePickerDate> {
  ...
  void _refreshEstimatedColumnWidths() {
    estimatedColumnWidths[_PickerColumnType.dayOfMonth.index] = PCupertinoDatePicker._getColumnWidth(_PickerColumnType.dayOfMonth, localizations, context);
    estimatedColumnWidths[_PickerColumnType.month.index] = PCupertinoDatePicker._getColumnWidth(_PickerColumnType.month, localizations, context);
    estimatedColumnWidths[_PickerColumnType.year.index] = PCupertinoDatePicker._getColumnWidth(_PickerColumnType.year, localizations, context);
  }

  ...
  Widget build(BuildContext context) {
    ...
    while (day < daysInMonth) {
      ...
      if (day < 1) {
        ...
        final bool isDisabled = dayToBuild.isAfter(lastDate) || dayToBuild.isBefore(firstDate) || (selectableDayPredicate != null && !selectableDayPredicate!(dayToBuild));
...
class _DayHeaders extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle? dayHeaderStyle = theme.textTheme.labelMedium?.apply(
